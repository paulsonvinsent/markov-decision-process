...
public class Problem {
    ...
    public Problem(String name, String[] map, HashMap<Algorithm, Integer> numIterations, double defaultReward, double goalReward, HashMap<HazardType, Double> hazardRewards) {
        this.name = name;
